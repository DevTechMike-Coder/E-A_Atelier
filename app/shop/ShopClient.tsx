...
function ShopContent({ products }: { products: Product[] }) {
  ...
  const categories = [
    { id: "all", label: `ALL PIECES (${countFor("all")})` },
    { id: "bags", label: `BAGS (${countFor("bags")})` },
    { id: "wearables", label: `WEARABLES (${countFor("wearables")})` },
    { id: "accessories", label: `ACCESSORIES (${countFor("accessories")})` },
    { id: "home", label: `HOME DÉCOR (${countFor("home")})` },
  ];
